                    ...
                    <c:forEach items="${allDeliveries}" var="deliv">
                        ...
                        <tr>
                            <c:forEach items ="${deliv.subdeliveries}"  var="sub">
                                ...
                                <td><button type="submit" class="btn btn-success btn btn-success" name="action" value="sub_ready<c:out value="${sub.idSubdelivery}"/>">Change in READY</button></td>
                            </tr>
                            </tr>
                        </c:forEach>
                        <tr>
                            ...
                            <td  style="visibility:hidden"></td>
                            <td style="visibility:hidden"></td>
                            <td><button type="submit" name="action" class="btn btn-success btn btn-success" value="gone<c:out value="${deliv.idDelivery}"/>">Change in GONE</button></td>
                        <tr>
                        </tr>
                    </c:forEach>
                </tbody>
